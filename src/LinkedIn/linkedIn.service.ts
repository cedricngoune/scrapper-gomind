...
export class LinkedInService implements Scrapper {
  private readonly http = new ClientService({
    ...
    headers: {
      ...
      referer:
        'https://www.linkedin.com/jobs/search/?currentJobId=3855600291&f_E=3&f_TPR=r86400&f_WT=3%2C1%2C2&geoId=105015875&keywords=node&location=Paris&origin=JOB_SEARCH_PAGE_JOB_FILTER&refresh=true'
    }
  })
